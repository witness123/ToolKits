 ...
 * FormartCurrentFile
 */
macro FormartCurrentFile()
{
	hbuf = GetCurrentBuf();
	curFilePath = GetBufName(hbuf)
	
	astyle_exe = "D:\DEVEL\ToolKits\AStyle\AStyle.exe"
	options_file = "D:\DEVEL\ToolKits\AStyle\style-options\style-options-default.txt"
	
	cmdLine = "@astyle_exe@ --options=%options_file% --quiet --preserve-date --suffix=none --lineend=windows @curFilePath@";
